...
class SymlinkCommand extends TerminusCommand implements SiteAwareInterface
{
	 ...
	 *
	 * @option boolean $transfer_source Transfer existing source directory to target directory similar to `mv wp-content/cache ../../files/cache`
	 * @option string $destination Custom target directory name similar to `mv wp-content/cache ../../files/<customName>
	 * @option boolean $pointtofile Symlink to file instead of directory similar to `mv wp-content/keys.xml ../../files/keys.xml`
	 * @option boolean $skip-download No need to download source
         *
	 * @usage <site>.<env> <src> --destination=<customName> An optional target directory name
	 * @usage <site>.<env> <src> --transfer_source Transfer existing source directory to files/symlink_target/<source>
	 * @usage <site>.<env> <src> --pointtofile Create target file instead of directory
	 * @usage <site>.<env> <src> --skip-download Skipping Download 
	 */
